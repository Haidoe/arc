...
import aboutDesktop from '~/../public/images/landing-page/aboutDesktop.png'
import aboutMobile from '~/../public/images/landing-page/aboutMobile.png'
  ...
  return (
    <div className='grid md:grid-cols-2'>
      ...
      <div className='text-contrast-base pt-12 pb-14 md:pt-16 md:pb-20 lg:pt-20 lg:pb-24 px-6 md:px-12 lg:px-36 flex flex-col gap-y-2 md:gap-4 lg:gap-6 self-center '>
        <h2 className='text-xl md:text-3xl xl:text-5xl text-primary-dark'>About</h2>
      ...
      <div className='max-h-[130px]'>
        <Image src={aboutMobile} alt='' aria-hidden='true' className='md:hidden' />
      </div>
    </div >
  )
}
