...
const MenuNavigationMobile = () => {
  ...
  return (
    // Assuming 'activePage' holds the name of the active page, e.g., 'Home', 'About', etc.

    // Assuming 'activePage' holds the name of the active page, e.g., 'Home', 'About', etc.

    <div className="overflow-x-hidden">
      <div className="fixed bottom-0 left-0 flex  w-full items-center justify-between gap-3 sm:gap-[4rem] md:gap-[7rem] border-t-[1px] border-contrast-light bg-arc px-4 lg:hidden">
        {/* Production Tab */}
        <Link href="/home" className="flex-1">
          <div
            className={`flex flex-col items-center gap-2 py-4 ${
              isActivePage() === "Home" ? "border-t-[6px] border-pink-500" : ""
            }`}
          >
        ...
        <Link
          ...
          className={`flex-1 ${
            pathname == "/home" ? "pointer-events-none text-contrast-light" : ""
          }`}
        >
          <div
            className={`flex flex-col items-center gap-2 py-4 ${
